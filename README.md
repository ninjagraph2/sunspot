...
- Производительность: меньше одной секунды на обработку запросов
...
- Приём телеметрии со спутников (статус зеркал. координаты, скорость, заряд итп
...
- Доступность: при каждом проявлении связи с Землёй  
